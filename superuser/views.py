...
from homepage.models import Orphanage,Events,review
import json
...
def givereview(request):
    ...
    if request.method=='POST':
        ...
        review.objects.create(description=description,rating=rating,user=request.user)
        w=review.objects.all()
        for i in w:
            print(i.rating)
        return render(request,'superuser/showreview.html',context={'list':w})
    else:
